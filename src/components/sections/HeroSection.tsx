    ...
    >
      ...
      <div className="mx-auto grid min-h-[calc(100svh-72px)] max-w-7xl items-center gap-12 px-5 py-16 sm:px-6 lg:grid-cols-[1.15fr_0.85fr] lg:px-8">
        ...
        >
          ...
          <div className="mt-5 grid max-w-3xl gap-2 text-sm leading-6 text-slate-600 dark:text-slate-300 sm:grid-cols-3">
            {[
              resumeData.stats[0],
              resumeData.stats[1],
              resumeData.stats[3],
              ...
              <div
                key={stat.label}
                className="rounded-md border border-slate-200 bg-white/70 px-3 py-2 dark:border-white/10 dark:bg-white/7"
              >
